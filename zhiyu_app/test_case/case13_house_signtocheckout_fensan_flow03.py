...
class SignToCheckout(unittest.TestCase):
    ...
    def test_sign_checkout(self):
        ...
        self.houseStatus.house_status_flow_fensan(data.district_fengtai, data.street_liuliqiao,
                                                  ...
                                                  data.room_no_402, data.user_01, data.rent_time_12, method='半年付',
                                                  fee1='物业费',
        ...
        self.houseStatus.bill_plan_page_check(total_money=54720.0,d1=date_now,money1=30360.00,date1=date_now,
                                              fe1=360.00,fe2=1000.00,fe3=4000.00,fe4=24000.00,fe5=1000.00,
                                              money2=24360.00,tag=2,status_fenqi='12_6'
                                              )
        ...
        self.orders.order_confirm_flow(data.community_fensan_02, data.room_no_402, data.remark, money_1=30360.00)
        """
        # 转到web端财务确认
        # self.driver_web = driver.Driver().driver_web_session(url_zhiyu_test)
        # self.login_web = login_w.PageActionLogin(self.driver_web)
        ...
        """
        # app端财务确认
        self.orders.caiwu_pay_confirm(data.community_fensan_02, data.room_no_402, money_t=30360.00, n=12)
        # 转到app执行退房
        self.home.click_tab_house_status()
        ...
        self.checkout.checkout_flow(data.item_bed, data.reason_bed, data.room_status,sign_n=12,rent_n=6,
                                    status_jiesuan='12_6', money_tui=8847.54)
        ...
        self.orders.refund_page(data.tuikuan_way_01, data.remark, data.bank_owner_name, data.bank_name, data.bank_count,money_tui=8847.54)
        """
        # 转到web端财务确认
        self.driver_web = driver.Driver().driver_web_session(url_zhiyu_test)
        self.login_web = login_w.PageActionLogin(self.driver_web)
        ...
        """
        # app财务退款确认
        self.orders.caiwu_pay_confirm_tuifei(data.community_fensan_02, data.room_no_402, money_tui=8847.54)
        # 退房完成
