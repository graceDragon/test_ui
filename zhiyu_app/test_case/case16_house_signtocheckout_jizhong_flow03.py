...
class SignToCheckout(unittest.TestCase):
    ...
    def test_sign_checkout(self):
        ...
        self.houseStatus.house_status_flow(data.community_jizhong_ui, data.loudong_name_jizhong_01,
                                           data.user_01, data.rent_time_12, method='半年付',
                                           fee1='物业费',zhouqi1='一次性', day=1, addmoney1='1000', furniture1='家电',
                                           model1='电冰箱',num1=1, mendian='测试门店1', saleman='用户四',
                                           fapiao='No',no='1001')
        date_now = str(date.today())
        self.houseStatus.bill_plan_page_check(total_money=118550.0,d1=date_now,money1=64730.00,date1=date_now,
                                              fe1=360.00,fe2=1000.00,fe3=8910.00,fe4=53460.00,fe5=1000.00,
                                              status_fenqi='12_6', money2=53820.00, tag=2
                                              )
        ...
        self.orders.order_confirm_flow(data.community_jizhong_ui,data.room_no_1001, data.remark, money_1=64730.00)
        """
        # 转到web端财务确认
        # self.driver_web = driver.Driver().driver_web_session(url_zhiyu_test)
        # self.login_web = login_w.PageActionLogin(self.driver_web)
        ...
        """
        # app端财务确认
        self.orders.caiwu_pay_confirm(data.community_jizhong_ui, data.room_no_1001, money_t=64730.00,n=12)
        # 转到app执行退房
        self.home.click_tab_house_status()
        ...
        self.checkout.checkout_flow_jizhong(data.item_bed, data.reason_bed, data.room_status,sign_n=12,rent_n=6,
                                            status_jiesuan='12_6', money_tui=6847.49)
