...
class SignToCheckout(unittest.TestCase):
    ...
    def test_sign_checkout(self):
        ...
        self.houseStatus.house_status_flow_fensan(data.district_fengtai, data.street_liuliqiao,
                                                  ...
                                                  data.room_no_402, data.user_01, data.rent_time_1, method='月付',
                                                  fee1='物业费',
        ...
        self.houseStatus.bill_plan_page_check(total_money=13060.0,d1=date_now,money1=13060.00,date1=date_now,
                                              fe1=60.00,fe2=1000.00,fe3=5500.00,fe4=5500.00,fe5=1000.00
                                              )
        ...
        self.orders.order_confirm_flow(data.community_fensan_02, data.room_no_402, data.remark, money_1=13060.00)
        """
        # 转到web端财务确认
        # self.driver_web = driver.Driver().driver_web_session(url_zhiyu_test)
        # self.login_web = login_w.PageActionLogin(self.driver_web)
        ...
        """
        # app端财务确认
        self.orders.caiwu_pay_confirm(data.community_fensan_02, data.room_no_402, money_t=13060.00)
        # 转到app执行退房
        self.home.click_tab_house_status()
        ...
        self.checkout.checkout_flow(data.item_bed, data.reason_bed, data.room_status)
        ...
        self.orders.refund_page(data.tuikuan_way_01, data.remark, data.bank_owner_name, data.bank_name, data.bank_count)
        """
        # 转到web端财务确认
        self.driver_web = driver.Driver().driver_web_session(url_zhiyu_test)
        self.login_web = login_w.PageActionLogin(self.driver_web)
        ...
        """
        # app财务退款确认
        self.orders.caiwu_pay_confirm_tuifei(data.community_fensan_02, data.room_no_402)
        # 退房完成
