...
class HouseJizhongSignFlow(unittest.TestCase):
    ...
    def test_house_jizhong_sign_flow(self):
        ...
        self.phs.house_status_order_close_flow(data.community_jizhong_ui, data.loudong_name_jizhong_01,
                                               data.room_no_1002,
                                               data.user_01)
        self.phome.click_tab_home()
        self.pao.click_wait_pay()
        self.pao.refress_screen()
        # self.pao.close_order_wait_pay(data.community_name, data.room_no_order)
        self.pao.confirm_order_wait_pay(data.community_jizhong_ui, data.room_no_1002)
        self.pao.fee_page_flow(money_1=1000, remark=data.remark)
        self.pao.caiwu_pay_dahui(data.community_jizhong_ui, data.room_no_1002)
        self.pao.click_wait_pay()
        self.pao.refress_screen()
        self.pao.close_order_wait_pay(data.community_jizhong_ui, data.room_no_1002)
        self.pao.confirm()
